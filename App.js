...
import { ToDoItemComponent } from './src/ToDoItem';
import { ToDoItem } from './src/models';
import { getDBConnection, getTodoItems, saveTodoItems, createTable, clearTable, deleteTodoItem } from './src/data/db-service';
const App = () => {
